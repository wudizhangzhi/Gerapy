<template>
	<div>
		<el-form-item :label="$lang.columns.name" label-width="60px" class="inline">
			<el-input
				v-model="item.name" :placeholder="$lang.columns.name"
				size="small"></el-input>
		</el-form-item>
		<el-form-item label-width="20px">
			<div v-for="(attr, attrKey, attrIndex) in item.attrs" :key="attrKey" class="field">
				...
				<el-form-item class="inline" label-width="0">
					<span :style="{width: '80px', textAlign: 'center', display: 'inline-block'}">{{ attrKey }}</span>
				</el-form-item>
				<el-form-item :label="$lang.columns.value" class="inline" label-width="60px">
					<el-input
						v-model="attr.value"
						:placeholder="$lang.columns.value"
						size="small"></el-input>
				</el-form-item>
				<el-form-item :label="$lang.columns.inProcessor" class="inline" label-width="100px">
					<el-input
