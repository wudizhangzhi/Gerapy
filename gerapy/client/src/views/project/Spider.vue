	...
	<div class="label-left">
		...
		<el-form-item :label="$lang.columns.startUrls">
			...
			<div v-if="spider.start_urls.mode === 'list'">
				...
				<div v-for="(url, urlIndex) in spider.start_urls.list" :key="'url' + urlIndex">
					<el-form-item class="inline" label-width="0">
						<el-input
							v-model="spider.start_urls.list[urlIndex]" class="inline"
							:placeholder="$lang.columns.startUrls" :style="{width: '600px'}"
							size="small"></el-input>
					</el-form-item>
					<el-form-item class="inline" label-width="0">
						<el-button type="danger" size="mini" @click="$delete(spider.start_urls.list, urlIndex)">
		...
		<el-form-item :label="$lang.columns.classAttrs">
			...
			<div v-for="(value, key) in spider.attrs" :key="'spider_attrs' + key" class="label-center">
				...
				<el-form-item class="inline">
					<el-button type="danger" size="mini" @click="$delete(spider.attrs, key)">
						<i class="fa fa-remove"></i>
						{{ $lang.buttons.delete }}
					</el-button>
				</el-form-item>
		...
		<el-form-item :label="$lang.columns.customSettings" :style="{marginBottom: '15px'}">
			...
			<div v-for="(value, key) in spider.custom_settings" :key="'spider_custom_settings' + key" class="label-center">
				<el-form-item class="inline" :label="$lang.columns.attrName">
					<el-input
